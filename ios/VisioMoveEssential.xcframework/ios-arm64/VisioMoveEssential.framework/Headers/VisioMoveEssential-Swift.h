...
///
- (void)setMapListener:(id <VMEMapListener> _Nullable)mapListener;
...
///
- (void)setBuildingListener:(id <VMEBuildingListener> _Nullable)buildingListener;
...
///
- (void)setLocationTrackingModeListener:(id <VMELocationTrackingModeListener> _Nullable)locationTrackingModeListener;
...
///
- (void)setCameraListener:(id <VMECameraListener> _Nullable)cameraListener;
...
///
- (void)setLifeCycleListener:(id <VMELifeCycleListener> _Nullable)lifeCycleListener;
...
///
- (void)setPoiListener:(id <VMEPoiListener> _Nullable)poiListener;
...
///
- (void)setNavigationListener:(id <VMENavigationListener> _Nullable)navigationListener;
...
///
- (void)setCompassListener:(id <VMECompassListener> _Nullable)compassListener;
...
///   </li>
///   <li>
///     fromDictionary: the dictionary representing theme to apply
///   </li>
/// </ul>
/// \code
/// let themeKeyValues = [
...
///  "buildingNormalPinForeground" : "#b927d3",
///  "buildingNormalPinBackground" : "#ffffff"
/// ]
/// let _ = mMapController.setTheme(fromDictionary: themeKeyValues)
///
/// \endcode
- (void)setThemeFromDictionary:(NSDictionary<NSString *, id> * _Nonnull)pData;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// version:
/// 2.0
@property (nonatomic) BOOL animateAllRoute;
/// Instantiates a route request.
/// note:
/// By default
/// <ul>
