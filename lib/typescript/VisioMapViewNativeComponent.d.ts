...
interface NativeCommands {
   ...
   * resetPoisColor : (
    ...
    **/
    animateCamera: (viewRef: React.ElementRef<NativeComponentType>, cameraupdate: VMCameraUpdate, duration: Double, callback: VMAnimationCallback | undefined) => void;
    ...
    setLocationTrackingButtonToggleModes: (viewRef: React.ElementRef<NativeComponentType>, togglemodes: [String]) => void;
    getNavigationHeaderViewVisible: (viewRef: React.ElementRef<NativeComponentType>) => Promise<boolean>;
    setNavigationHeaderViewVisible: (viewRef: React.ElementRef<NativeComponentType>, bool: boolean) => void;
